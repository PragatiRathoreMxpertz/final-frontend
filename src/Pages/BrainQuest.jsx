...
import { Get_Copy_brainQuest, Update_Copy_brainQuest } from "../store/Slice/BrainQuestSlice";
// import {
...
const BrainQuest = ({ questionsData }) => {
  ...
  if (!questions || questions.length === 0) {
    return (
      <div className="text-white font-bold">You have Already Submitted the BrainQuestData for this Story. </div>
    );
  }
  ...
  return (
    <div className="quiz-container">
      {showScore ? (
        ...
        <p>BrainQuestData already Exists</p>
      ) : (
        <>
          <ProgressBar
          ...
          <div className="question-container">
            ...
            <div className="button-container">
              ...
              <button
                ...
                onClick={handleNext}
                disabled={
                  selectedAnswers[currentQuestionIndex] === null || showScore
                }
              >
