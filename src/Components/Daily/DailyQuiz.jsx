        ...
        <>
            ...
            <div className={showbg ? `Dailyquiz-container` : ""}>
                ...
                {showScore ? (
                    ...
                    <>
                        {!questions || questions.length === 0 ? <div className='text-white font-bold'>No more questions for today! Check back tomorrow for your next quiz. Keep up the great work and see you soon</div> : <>
                            ...
                            <div className="DailyQuizebutton-container ">
                                ...
                                <button className="DailyQuize-next-button" onClick={handleNext}
